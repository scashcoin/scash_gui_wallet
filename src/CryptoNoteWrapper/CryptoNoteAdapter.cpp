...
void CryptoNoteAdapter::initAutoConnection() {
  ...
  m_nodeAdapter = new ProxyRpcNodeAdapter(m_currency, m_coreLogger, m_walletLogger, "54.39.98.224", CryptoNote::RPC_DEFAULT_PORT, this);
...
void CryptoNoteAdapter::initLocalRpcNode() {
  m_nodeAdapter = new ProxyRpcNodeAdapter(m_currency, m_coreLogger, m_walletLogger, "149.28.109.41", CryptoNote::RPC_DEFAULT_PORT, this);
  m_nodeAdapter->addObserver(this);
  m_nodeAdapter->init();
}
